'''
Copied wholesale on 2018-01-18 from https://developers.google.com/gmail/api/quickstart/python
Only the credential_path in get_credentials() was changed to be local
...
def get_credentials():
    ...
    """
    credential_path = 'gmail_metrics_auth.json'
